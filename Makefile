...
NON_TEXT_FILES_REGEX = "\.pyc$$|^\.git/|^\.idea/|^\.ruff_cache/|^.mypy_cache/|^.coverage$$|^pytest_results/|^.pytest_cache/|^data/"
...
# Run all linters
lint: whitespace-format-check init-file-checker black-check isort-check ruff flake8 pylint mypy

# Fix code formatting.
fix: whitespace-format init-file-checker-add-missing black-format isort-format ruff-fix
